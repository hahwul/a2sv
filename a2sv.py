...
def mainScreen():
    ...
    showDisplay(displayMode,"                                   /^--^o     /^--^o     /^--^o ")
    showDisplay(displayMode,"                                   o____/     o____/     o____/ ")
    showDisplay(displayMode,"                                  /      o   /      o   /      o ")
    showDisplay(displayMode,"                                 |        | |        | |        | ")
    showDisplay(displayMode," █████╗ ██████╗ ███████╗██╗   ██╗ o__  __/   o__  __/   o__  __/ ")
    showDisplay(displayMode,"██╔══██╗╚════██╗██╔════╝██║   ██║|^|^o o^|^|^|^/ /^|^|^|^|^o o^|^|^|")
    showDisplay(displayMode,"███████║ █████╔╝███████╗██║   ██║| | |o o| | |/ /| | | | | | o o | |")
    showDisplay(displayMode,"██╔══██║██╔═══╝ ╚════██║╚██╗ ██╔╝|###/ /######o o###########/ /####|")
    showDisplay(displayMode,"██║  ██║███████╗███████║ ╚████╔╝ | | o/| | | | o/| | | | | |o/ | | |")
    showDisplay(displayMode,"╚═╝  ╚═╝╚══════╝╚══════╝  ╚═══╝  |_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|_|")
    showDisplay(displayMode,BLUE+"[Auto Scanning to SSL Vulnerability "+a2sv_version+"] By HaHwul / www.hahwul.com"+END)
